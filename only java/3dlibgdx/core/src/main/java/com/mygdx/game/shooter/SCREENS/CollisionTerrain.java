...
public class CollisionTerrain implements Screen {
...
//        GameObject obj = constructors.values[4].construct();

        obj.transform.setFromEulerAngles(MathUtils.random(360f), MathUtils.random(360f), MathUtils.random(360f));
//        obj.transform.setFromEulerAngles(250,240, 200);
